    ...
    return (
        <AlertDialog.Root>
            ...
            <AlertDialog.Portal>
                ...
                <AlertDialog.Content className="data-[state=open]:animate-content Show border-2 border-violet-800 fixed top-[61%] left-[50%] max-h-[90vh] w-[100vw] max-w-[720px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-black p-[10px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
